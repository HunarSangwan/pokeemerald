...
extern const u8 gText_StarterChoiceNumber[];
...
extern const u8 gText_CHARMELEON[];
extern const u8 gText_CHARIZARD[];
extern const u8 gText_SQUIRTLE[];
extern const u8 gText_WARTORTLE[];
extern const u8 gText_BLASTOISE[];
extern const u8 gText_CATERPIE[];
extern const u8 gText_METAPOD[];
extern const u8 gText_BUTTERFREE[];
extern const u8 gText_WEEDLE[];
extern const u8 gText_KAKUNA[];
extern const u8 gText_BEEDRILL[];
extern const u8 gText_PIDGEY[];
extern const u8 gText_PIDGEOTTO[];
extern const u8 gText_PIDGEOT[];
extern const u8 gText_RATTATA[];
extern const u8 gText_RATICATE[];
extern const u8 gText_SPEAROW[];
extern const u8 gText_FEAROW[];
extern const u8 gText_EKANS[];
extern const u8 gText_ARBOK[];
extern const u8 gText_PIKACHU[];
extern const u8 gText_RAICHU[];
extern const u8 gText_SANDSHREW[];
extern const u8 gText_SANDSLASH[];
extern const u8 gText_NIDORAN_F[];
extern const u8 gText_NIDORINA[];
extern const u8 gText_NIDOQUEEN[];
extern const u8 gText_NIDORAN_M[];
extern const u8 gText_NIDORINO[];
extern const u8 gText_NIDOKING[];
extern const u8 gText_CLEFAIRY[];
extern const u8 gText_CLEFABLE[];
extern const u8 gText_VULPIX[];
extern const u8 gText_NINETALES[];
extern const u8 gText_JIGGLYPUFF[];
extern const u8 gText_WIGGLYTUFF[];
extern const u8 gText_ZUBAT[];
extern const u8 gText_GOLBAT[];
extern const u8 gText_ODDISH[];
extern const u8 gText_GLOOM[];
extern const u8 gText_VILEPLUME[];
extern const u8 gText_PARAS[];
extern const u8 gText_PARASECT[];
extern const u8 gText_VENONAT[];
extern const u8 gText_VENOMOTH[];
extern const u8 gText_DIGLETT[];
extern const u8 gText_DUGTRIO[];
extern const u8 gText_MEOWTH[];
extern const u8 gText_PERSIAN[];
extern const u8 gText_PSYDUCK[];
extern const u8 gText_GOLDUCK[];
extern const u8 gText_MANKEY[];
extern const u8 gText_PRIMEAPE[];
extern const u8 gText_GROWLITHE[];
extern const u8 gText_ARCANINE[];
extern const u8 gText_POLIWAG[];
extern const u8 gText_POLIWHIRL[];
extern const u8 gText_POLIWRATH[];
extern const u8 gText_ABRA[];
extern const u8 gText_KADABRA[];
extern const u8 gText_ALAKAZAM[];
extern const u8 gText_MACHOP[];
extern const u8 gText_MACHOKE[];
extern const u8 gText_MACHAMP[];
extern const u8 gText_BELLSPROUT[];
extern const u8 gText_WEEPINBELL[];
extern const u8 gText_VICTREEBEL[];
extern const u8 gText_TENTACOOL[];
extern const u8 gText_TENTACRUEL[];
extern const u8 gText_GEODUDE[];
extern const u8 gText_GRAVELER[];
extern const u8 gText_GOLEM[];
extern const u8 gText_PONYTA[];
extern const u8 gText_RAPIDASH[];
extern const u8 gText_SLOWPOKE[];
extern const u8 gText_SLOWBRO[];
extern const u8 gText_MAGNEMITE[];
extern const u8 gText_MAGNETON[];
extern const u8 gText_FARFETCHD[];
extern const u8 gText_DODUO[];
extern const u8 gText_DODRIO[];
extern const u8 gText_SEEL[];
extern const u8 gText_DEWGONG[];
extern const u8 gText_GRIMER[];
extern const u8 gText_MUK[];
extern const u8 gText_SHELLDER[];
extern const u8 gText_CLOYSTER[];
extern const u8 gText_GASTLY[];
extern const u8 gText_HAUNTER[];
extern const u8 gText_GENGAR[];
extern const u8 gText_ONIX[];
extern const u8 gText_DROWZEE[];
extern const u8 gText_HYPNO[];
extern const u8 gText_KRABBY[];
extern const u8 gText_KINGLER[];
extern const u8 gText_VOLTORB[];
extern const u8 gText_ELECTRODE[];
extern const u8 gText_EXEGGCUTE[];
extern const u8 gText_EXEGGUTOR[];
extern const u8 gText_CUBONE[];
extern const u8 gText_MAROWAK[];
extern const u8 gText_HITMONLEE[];
extern const u8 gText_HITMONCHAN[];
extern const u8 gText_LICKITUNG[];
extern const u8 gText_KOFFING[];
extern const u8 gText_WEEZING[];
extern const u8 gText_RHYHORN[];
extern const u8 gText_RHYDON[];
extern const u8 gText_CHANSEY[];
extern const u8 gText_TANGELA[];
extern const u8 gText_KANGASKHAN[];
extern const u8 gText_HORSEA[];
extern const u8 gText_SEADRA[];
extern const u8 gText_GOLDEEN[];
extern const u8 gText_SEAKING[];
extern const u8 gText_STARYU[];
extern const u8 gText_STARMIE[];
extern const u8 gText_MR_MIME[];
extern const u8 gText_SCYTHER[];
extern const u8 gText_JYNX[];
extern const u8 gText_ELECTABUZZ[];
extern const u8 gText_MAGMAR[];
extern const u8 gText_PINSIR[];
extern const u8 gText_TAUROS[];
extern const u8 gText_MAGIKARP[];
extern const u8 gText_GYARADOS[];
extern const u8 gText_LAPRAS[];
extern const u8 gText_DITTO[];
...
extern const u8 gText_OMANYTE[];
extern const u8 gText_OMASTAR[];
extern const u8 gText_KABUTO[];
extern const u8 gText_KABUTOPS[];
extern const u8 gText_AERODACTYL[];
extern const u8 gText_SNORLAX[];
extern const u8 gText_ARTICUNO[];
extern const u8 gText_ZAPDOS[];
extern const u8 gText_MOLTRES[];
extern const u8 gText_DRATINI[];
extern const u8 gText_DRAGONAIR[];
extern const u8 gText_DRAGONITE[];
extern const u8 gText_MEWTWO[];
extern const u8 gText_MEW[];
extern const u8 gText_CHIKORITA[];
extern const u8 gText_BAYLEEF[];
extern const u8 gText_MEGANIUM[];
extern const u8 gText_CYNDAQUIL[];
extern const u8 gText_QUILAVA[];
extern const u8 gText_TYPHLOSION[];
extern const u8 gText_TOTODILE[];
extern const u8 gText_CROCONAW[];
extern const u8 gText_FERALIGATR[];
extern const u8 gText_SENTRET[];
extern const u8 gText_FURRET[];
extern const u8 gText_HOOTHOOT[];
extern const u8 gText_NOCTOWL[];
extern const u8 gText_LEDYBA[];
extern const u8 gText_LEDIAN[];
extern const u8 gText_SPINARAK[];
extern const u8 gText_ARIADOS[];
extern const u8 gText_CROBAT[];
extern const u8 gText_CHINCHOU[];
extern const u8 gText_LANTURN[];
extern const u8 gText_PICHU[];
extern const u8 gText_CLEFFA[];
extern const u8 gText_IGGLYBUFF[];
extern const u8 gText_TOGEPI[];
extern const u8 gText_TOGETIC[];
extern const u8 gText_NATU[];
extern const u8 gText_XATU[];
extern const u8 gText_MAREEP[];
extern const u8 gText_FLAAFFY[];
extern const u8 gText_AMPHAROS[];
extern const u8 gText_BELLOSSOM[];
extern const u8 gText_MARILL[];
extern const u8 gText_AZUMARILL[];
extern const u8 gText_SUDOWOODO[];
extern const u8 gText_POLITOED[];
extern const u8 gText_HOPPIP[];
extern const u8 gText_SKIPLOOM[];
extern const u8 gText_JUMPLUFF[];
extern const u8 gText_AIPOM[];
extern const u8 gText_SUNKERN[];
extern const u8 gText_SUNFLORA[];
extern const u8 gText_YANMA[];
extern const u8 gText_WOOPER[];
extern const u8 gText_QUAGSIRE[];
extern const u8 gText_ESPEON[];
extern const u8 gText_UMBREON[];
extern const u8 gText_MURKROW[];
extern const u8 gText_SLOWKING[];
extern const u8 gText_MISDREAVUS[];
extern const u8 gText_UNOWN[];
extern const u8 gText_WOBBUFFET[];
extern const u8 gText_GIRAFARIG[];
extern const u8 gText_PINECO[];
extern const u8 gText_FORRETRESS[];
extern const u8 gText_DUNSPARCE[];
extern const u8 gText_GLIGAR[];
extern const u8 gText_STEELIX[];
extern const u8 gText_SNUBBULL[];
extern const u8 gText_GRANBULL[];
extern const u8 gText_QWILFISH[];
extern const u8 gText_SCIZOR[];
extern const u8 gText_SHUCKLE[];
extern const u8 gText_HERACROSS[];
extern const u8 gText_SNEASEL[];
extern const u8 gText_TEDDIURSA[];
extern const u8 gText_URSARING[];
extern const u8 gText_SLUGMA[];
extern const u8 gText_MAGCARGO[];
extern const u8 gText_SWINUB[];
extern const u8 gText_PILOSWINE[];
extern const u8 gText_CORSOLA[];
extern const u8 gText_REMORAID[];
extern const u8 gText_OCTILLERY[];
extern const u8 gText_DELIBIRD[];
extern const u8 gText_MANTINE[];
extern const u8 gText_SKARMORY[];
extern const u8 gText_HOUNDOUR[];
extern const u8 gText_HOUNDOOM[];
extern const u8 gText_KINGDRA[];
extern const u8 gText_PHANPY[];
extern const u8 gText_DONPHAN[];
extern const u8 gText_PORYGON[];
extern const u8 gText_STANTLER[];
extern const u8 gText_SMEARGLE[];
extern const u8 gText_TYROGUE[];
extern const u8 gText_HITMONTOP[];
extern const u8 gText_SMOOCHUM[];
extern const u8 gText_ELEKID[];
extern const u8 gText_MAGBY[];
extern const u8 gText_MILTANK[];
extern const u8 gText_BLISSEY[];
extern const u8 gText_RAIKOU[];
extern const u8 gText_ENTEI[];
extern const u8 gText_SUICUNE[];
extern const u8 gText_LARVITAR[];
extern const u8 gText_PUPITAR[];
extern const u8 gText_TYRANITAR[];
extern const u8 gText_LUGIA[];
extern const u8 gText_HO_OH[];
extern const u8 gText_CELEBI[];
extern const u8 gText_TREECKO[]; 
extern const u8 gText_GROVYLE[]; 
extern const u8 gText_SCEPTILE[]; 
extern const u8 gText_TORCHIC[]; 
extern const u8 gText_COMBUSKEN[]; 
extern const u8 gText_BLAZIKEN[]; 
extern const u8 gText_MUDKIP[]; 
extern const u8 gText_MARSHTOMP[]; 
extern const u8 gText_SWAMPERT[]; 
extern const u8 gText_POOCHYENA[]; 
extern const u8 gText_MIGHTYENA[]; 
extern const u8 gText_ZIGZAGOON[]; 
extern const u8 gText_LINOONE[]; 
extern const u8 gText_WURMPLE[]; 
extern const u8 gText_SILCOON[]; 
extern const u8 gText_BEAUTIFLY[]; 
extern const u8 gText_CASCOON[]; 
extern const u8 gText_DUSTOX[]; 
extern const u8 gText_LOTAD[]; 
extern const u8 gText_LOMBRE[]; 
extern const u8 gText_LUDICOLO[]; 
extern const u8 gText_SEEDOT[]; 
extern const u8 gText_NUZLEAF[]; 
extern const u8 gText_SHIFTRY[]; 
extern const u8 gText_NINCADA[]; 
extern const u8 gText_NINJASK[]; 
extern const u8 gText_SHEDINJA[]; 
extern const u8 gText_TAILLOW[]; 
extern const u8 gText_SWELLOW[];
extern const u8 gText_SHROOMISH[]; 
extern const u8 gText_BRELOOM[]; 
extern const u8 gText_SPINDA[]; 
extern const u8 gText_WINGULL[]; 
extern const u8 gText_PELIPPER[]; 
extern const u8 gText_SURSKIT[]; 
extern const u8 gText_MASQUERAIN[]; 
extern const u8 gText_WAILMER[]; 
extern const u8 gText_WAILORD[]; 
extern const u8 gText_SKITTY[]; 
extern const u8 gText_DELCATTY[]; 
extern const u8 gText_KECLEON[]; 
extern const u8 gText_BALTOY[]; 
extern const u8 gText_CLAYDOL[]; 
extern const u8 gText_NOSEPASS[]; 
extern const u8 gText_TORKOAL[]; 
extern const u8 gText_SABLEYE[]; 
extern const u8 gText_BARBOACH[]; 
extern const u8 gText_WHISCASH[]; 
extern const u8 gText_LUVDISC[]; 
extern const u8 gText_CORPHISH[]; 
extern const u8 gText_CRAWDAUNT[]; 
extern const u8 gText_FEEBAS[]; 
extern const u8 gText_MILOTIC[]; 
extern const u8 gText_CARVANHA[]; 
extern const u8 gText_SHARPEDO[]; 
extern const u8 gText_TRAPINCH[]; 
extern const u8 gText_VIBRAVA[]; 
extern const u8 gText_FLYGON[]; 
extern const u8 gText_MAKUHITA[]; 
extern const u8 gText_HARIYAMA[]; 
extern const u8 gText_ELECTRIKE[]; 
extern const u8 gText_MANECTRIC[]; 
extern const u8 gText_NUMEL[]; 
extern const u8 gText_CAMERUPT[]; 
extern const u8 gText_SPHEAL[]; 
extern const u8 gText_SEALEO[]; 
extern const u8 gText_WALREIN[]; 
extern const u8 gText_CACNEA[]; 
extern const u8 gText_CACTURNE[]; 
extern const u8 gText_SNORUNT[]; 
extern const u8 gText_GLALIE[]; 
extern const u8 gText_LUNATONE[]; 
extern const u8 gText_SOLROCK[]; 
extern const u8 gText_AZURILL[]; 
extern const u8 gText_SPOINK[]; 
extern const u8 gText_GRUMPIG[]; 
extern const u8 gText_PLUSLE[]; 
extern const u8 gText_MINUN[]; 
extern const u8 gText_MAWILE[]; 
extern const u8 gText_MEDITITE[]; 
extern const u8 gText_MEDICHAM[]; 
extern const u8 gText_SWABLU[]; 
extern const u8 gText_ALTARIA[]; 
extern const u8 gText_WYNAUT[]; 
extern const u8 gText_DUSKULL[]; 
extern const u8 gText_DUSCLOPS[]; 
extern const u8 gText_ROSELIA[]; 
extern const u8 gText_SLAKOTH[]; 
extern const u8 gText_VIGOROTH[]; 
extern const u8 gText_SLAKING[]; 
extern const u8 gText_GULPIN[]; 
extern const u8 gText_SWALOT[]; 
extern const u8 gText_TROPIUS[]; 
extern const u8 gText_WHISMUR[]; 
extern const u8 gText_LOUDRED[]; 
extern const u8 gText_EXPLOUD[]; 
extern const u8 gText_CLAMPERL[]; 
extern const u8 gText_HUNTAIL[]; 
extern const u8 gText_GOREBYSS[]; 
extern const u8 gText_ABSOL[]; 
extern const u8 gText_SHUPPET[]; 
extern const u8 gText_BANETTE[]; 
extern const u8 gText_SEVIPER[]; 
extern const u8 gText_ZANGOOSE[]; 
extern const u8 gText_RELICANTH[]; 
extern const u8 gText_ARON[]; 
extern const u8 gText_LAIRON[]; 
extern const u8 gText_AGGRON[]; 
extern const u8 gText_CASTFORM[]; 
extern const u8 gText_VOLBEAT[]; 
extern const u8 gText_ILLUMISE[]; 
extern const u8 gText_LILEEP[]; 
extern const u8 gText_CRADILY[]; 
extern const u8 gText_ANORITH[]; 
extern const u8 gText_ARMALDO[]; 
extern const u8 gText_RALTS[]; 
extern const u8 gText_KIRLIA[]; 
extern const u8 gText_GARDEVOIR[]; 
extern const u8 gText_BAGON[]; 
extern const u8 gText_SHELGON[]; 
extern const u8 gText_SALAMENCE[]; 
extern const u8 gText_BELDUM[]; 
extern const u8 gText_METANG[]; 
extern const u8 gText_METAGROSS[]; 
extern const u8 gText_REGIROCK[]; 
extern const u8 gText_REGICE[]; 
extern const u8 gText_REGISTEEL[]; 
extern const u8 gText_KYOGRE[]; 
extern const u8 gText_GROUDON[]; 
extern const u8 gText_RAYQUAZA[]; 
