const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_KADABRA]    = {{EVO_LEVEL, 55, SPECIES_ALAKAZAM}},
    ...
    [SPECIES_ONIX]       = {{EVO_LEVEL, 45, SPECIES_STEELIX}},
    [SPECIES_DROWZEE]    = {{EVO_LEVEL, 38, SPECIES_HYPNO}},
    ...
    [SPECIES_SEADRA]     = {{EVO_LEVEL, 55, SPECIES_KINGDRA}},
    ...
    [SPECIES_PORYGON]    = {{EVO_LEVEL, 42, SPECIES_PORYGON2}},
    ...
    [SPECIES_HOUNDOUR]   = {{EVO_LEVEL, 66, SPECIES_HOUNDOOM}},
    [SPECIES_PHANPY]     = {{EVO_LEVEL, 25, SPECIES_DONPHAN}},
    [SPECIES_TYROGUE]    = {{EVO_LEVEL_ATK_LT_DEF, 15, SPECIES_HITMONCHAN},
                            {EVO_LEVEL_ATK_GT_DEF, 15, SPECIES_HITMONLEE},
                            {EVO_LEVEL_ATK_EQ_DEF, 15, SPECIES_HITMONTOP}},
    ...
    [SPECIES_WAILMER]    = {{EVO_LEVEL, 70, SPECIES_WAILORD}},
    ...
    [SPECIES_CACNEA]     = {{EVO_LEVEL, 29, SPECIES_CACTURNE}},
    ...
    [SPECIES_WYNAUT]     = {{EVO_LEVEL, 64, SPECIES_WOBBUFFET}},
    [SPECIES_DUSKULL]    = {{EVO_LEVEL, 65, SPECIES_DUSCLOPS}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_LEVEL, 24, SPECIES_HUNTAIL},
