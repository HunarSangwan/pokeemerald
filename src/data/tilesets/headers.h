...
const struct Tileset gTileset_berry_forest =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_berry_forest,
    .palettes = gTilesetPalettes_berry_forest,
    .metatiles = gMetatiles_berry_forest,
...
const struct Tileset gTileset_cinnabar_gym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_cinnabar_gym,
    .palettes = gTilesetPalettes_cinnabar_gym,
    .metatiles = gMetatiles_cinnabar_gym,
...
const struct Tileset gTileset_department_store =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_department_store,
    .palettes = gTilesetPalettes_department_store,
    .metatiles = gMetatiles_department_store,
...
const struct Tileset gTileset_game_corner =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_game_corner,
    .palettes = gTilesetPalettes_game_corner,
    .metatiles = gMetatiles_game_corner,
...
const struct Tileset gTileset_pokemon_mansion =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_pokemon_mansion,
    .palettes = gTilesetPalettes_pokemon_mansion,
    .metatiles = gMetatiles_pokemon_mansion,
    .metatileAttributes = gMetatileAttributes_pokemon_mansion,
    .callback = NULL,
};

const struct Tileset gTileset_pokemon_tower =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_pokemon_tower,
    .palettes = gTilesetPalettes_pokemon_tower,
    .metatiles = gMetatiles_pokemon_tower,
...
const struct Tileset gTileset_rock_tunnel =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_rock_tunnel,
    .palettes = gTilesetPalettes_rock_tunnel,
    .metatiles = gMetatiles_rock_tunnel,
...
const struct Tileset gTileset_tanoby_ruins =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_tanoby_ruins,
    .palettes = gTilesetPalettes_tanoby_ruins,
    .metatiles = gMetatiles_tanoby_ruins,
...
const struct Tileset gTileset_viridian_city =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_viridian_city,
    .palettes = gTilesetPalettes_viridian_city,
    .metatiles = gMetatiles_viridian_city,
