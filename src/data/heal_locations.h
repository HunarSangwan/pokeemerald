static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_VIRIDIAN_CITY - 1] = {MAP_GROUP(VIRIDIAN_CITY), MAP_NUM(VIRIDIAN_CITY), 24, 20},
    [HEAL_LOCATION_PEWTER_CITY - 1] = {MAP_GROUP(PEWTER_CITY), MAP_NUM(PEWTER_CITY), 24, 20},
    [HEAL_LOCATION_CERULEAN_CITY - 1] = {MAP_GROUP(CERULEAN_CITY), MAP_NUM(CERULEAN_CITY), 24, 20},
    [HEAL_LOCATION_LAVENDER_TOWN - 1] = {MAP_GROUP(LAVENDER_TOWN), MAP_NUM(LAVENDER_TOWN), 12, 10},
    [HEAL_LOCATION_VERMILLION_CITY - 1] = {MAP_GROUP(VERMILLION_CITY), MAP_NUM(VERMILLION_CITY), 24, 20},
    [HEAL_LOCATION_CELADON_CITY - 1] = {MAP_GROUP(CELADON_CITY), MAP_NUM(CELADON_CITY), 32, 20},
    [HEAL_LOCATION_FUCHSIA_CITY - 1] = {MAP_GROUP(FUCHSIA_CITY), MAP_NUM(FUCHSIA_CITY), 24, 20},
    [HEAL_LOCATION_CINNABAR_ISLAND - 1] = {MAP_GROUP(CINNABAR_ISLAND), MAP_NUM(CINNABAR_ISLAND), 12, 10},
    [HEAL_LOCATION_INDIGO_PLATEAU_EXTERIOR - 1] = {MAP_GROUP(INDIGO_PLATEAU_EXTERIOR), MAP_NUM(INDIGO_PLATEAU_EXTERIOR), 12, 10},
    [HEAL_LOCATION_SAFFRON_CITY - 1] = {MAP_GROUP(SAFFRON_CITY), MAP_NUM(SAFFRON_CITY), 35, 27},
    [HEAL_LOCATION_SAFFRON_CITY_CONNECTION - 1] = {MAP_GROUP(SAFFRON_CITY_CONNECTION), MAP_NUM(SAFFRON_CITY_CONNECTION), 24, 20},
    [HEAL_LOCATION_ONE_ISLAND - 1] = {MAP_GROUP(ONE_ISLAND), MAP_NUM(ONE_ISLAND), 12, 10},
    [HEAL_LOCATION_TWO_ISLAND - 1] = {MAP_GROUP(TWO_ISLAND), MAP_NUM(TWO_ISLAND), 24, 10},
    [HEAL_LOCATION_THREE_ISLAND - 1] = {MAP_GROUP(THREE_ISLAND), MAP_NUM(THREE_ISLAND), 12, 20},
    [HEAL_LOCATION_FOUR_ISLAND - 1] = {MAP_GROUP(FOUR_ISLAND), MAP_NUM(FOUR_ISLAND), 24, 20},
    [HEAL_LOCATION_FIVE_ISLAND - 1] = {MAP_GROUP(FIVE_ISLAND), MAP_NUM(FIVE_ISLAND), 12, 10},
    [HEAL_LOCATION_SIX_ISLAND - 1] = {MAP_GROUP(SIX_ISLAND), MAP_NUM(SIX_ISLAND), 12, 15},
    [HEAL_LOCATION_SEVEN_ISLAND - 1] = {MAP_GROUP(SEVEN_ISLAND), MAP_NUM(SEVEN_ISLAND), 12, 10},
    [HEAL_LOCATION_ROUTE4 - 1] = {MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4), 35, 10},
