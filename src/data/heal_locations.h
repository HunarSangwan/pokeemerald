static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_VERMILLION_CITY - 1] = {MAP_GROUP(VERMILLION_CITY), MAP_NUM(VERMILLION_CITY), 15, 7},
    ...
    [HEAL_LOCATION_INDIGO_PLATEAU_EXTERIOR - 1] = {MAP_GROUP(INDIGO_PLATEAU_EXTERIOR), MAP_NUM(INDIGO_PLATEAU_EXTERIOR), 11, 7},
    [HEAL_LOCATION_SAFFRON_CITY - 1] = {MAP_GROUP(SAFFRON_CITY), MAP_NUM(SAFFRON_CITY), 24, 39},
    [HEAL_LOCATION_SAFFRON_CITY_CONNECTION - 1] = {MAP_GROUP(SAFFRON_CITY_CONNECTION), MAP_NUM(SAFFRON_CITY_CONNECTION), 14, 32},
