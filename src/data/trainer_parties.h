...
static const struct TrainerMon sParty_Tammy[] = {
    ...
    .moves = {MOVE_AERIAL_ACE, MOVE_ROCK_TOMB, MOVE_BRICK_BREAK, MOVE_SECRET_POWER}
    },
    {
    .iv = 252,
    .lvl = 13,
    ...
    .moves = {MOVE_ROCK_TOMB, MOVE_AURORA_BEAM, MOVE_WATER_PULSE, MOVE_RECOVER}
    },
    {
    .iv = 252,
    .lvl = 15,
    ...
    .moves = {MOVE_MEGAHORN, MOVE_ROCK_TOMB, MOVE_ICE_BEAM, MOVE_MAGNITUDE}
    },
    {
    .iv = 196,
    .lvl = 11,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_ANCIENT_POWER, MOVE_SILVER_WIND, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 196,
    .lvl = 11,
    ...
    .moves = {MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_FACADE, MOVE_SLEEP_TALK}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SELF_DESTRUCT, MOVE_THUNDER_WAVE, MOVE_SEISMIC_TOSS, MOVE_ATTRACT}
    },
    {
    .iv = 252,
    .lvl = 14,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_ANCIENT_POWER, MOVE_RECOVER}
    },
    {
    .iv = 252,
    .lvl = 14,
    ...
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_AERIAL_ACE, MOVE_BRICK_BREAK, MOVE_ROCK_SLIDE, MOVE_X_SCISSORS}
    },
    {
    .iv = 252,
    .lvl = 14,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_THROW, MOVE_SECRET_POWER, MOVE_WATER_PULSE, MOVE_YAWN}
    },
    {
    .iv = 252,
    .lvl = 14,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROLLOUT, MOVE_SUNNY_DAY, MOVE_CURSE, MOVE_TOXIC}
    },
    {
    .iv = 252,
    .lvl = 15,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_CONFUSION, MOVE_ROCK_SLIDE, MOVE_MOONLIGHT, MOVE_HYPNOSIS}
    }
};
...
static const struct TrainerMon sParty_Jerry1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HORN_ATTACK, MOVE_DIG, MOVE_ROCK_TOMB, MOVE_TOXIC}
    },
    {
    .iv = 98,
    .lvl = 9,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MUD_SHOT, MOVE_ROCK_TOMB, MOVE_SECRET_POWER, MOVE_ATTRACT}
    }
};
...
static const struct TrainerMon sParty_Karen1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_DIVE, MOVE_DIG, MOVE_NONE}
    },
    {
    .iv = 147,
    .lvl = 9,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_EMBER, MOVE_DIG, MOVE_NONE}
    },
    {
    .iv = 196,
    .lvl = 9,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_SECRET_POWER, MOVE_SYNTHESIS, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Calvin1[] = {
    ...
    .moves = {MOVE_ASSIST, MOVE_QUICK_ATTACK, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 0,
    .lvl = 6,
    .species = SPECIES_POOCHYENA,
    .moves = {MOVE_BITE, MOVE_SUPER_FANG, MOVE_MUD_SLAP, MOVE_ROCK_SMASH}
    },
    {
    .iv = 0,
    .lvl = 6,
    .species = SPECIES_ZIGZAGOON,
    .moves = {MOVE_SWIFT, MOVE_SAND_ATTACK, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Josh[] = {
    ...
    .moves = {MOVE_GIGA_DRAIN, MOVE_AERIAL_ACE, MOVE_LEECH_LIFE, MOVE_HYPNOSIS}
    },
    {
    .iv = 252,
    .lvl = 12,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_ROCK_TOMB, MOVE_CALM_MIND}
    },
    {
    .iv = 252,
    .lvl = 14,
    ...
    .heldItem = ITEM_HARD_STONE,
    .moves = {MOVE_WATER_PULSE, MOVE_ROCK_TOMB, MOVE_AURORA_BEAM, MOVE_BITE}
    }
};
...
static const struct TrainerMon sParty_Joey[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_BITE, MOVE_SECRET_POWER, MOVE_WATER_PULSE}
    },
    {
    .iv = 196,
    .lvl = 10,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ACID, MOVE_BITE, MOVE_MEGA_DRAIN, MOVE_GLARE}
    },
    {
    .iv = 252,
    .lvl = 10,
...
static const struct TrainerMon sParty_Allen[] = {
    ...
    .species = SPECIES_SILCOON,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POISON_STING, MOVE_TACKLE, MOVE_IRON_DEFENSE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Marc[] = {
    ...
    .moves = {MOVE_DIG, MOVE_ROCK_TOMB, MOVE_SELF_DESTRUCT, MOVE_SWAGGER}
    },
    {
    .iv = 252,
    .lvl = 12,
    ...
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_NEEDLE_ARM, MOVE_STOMP, MOVE_TEETER_DANCE, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 252,
    .lvl = 14,
    ...
    .moves = {MOVE_AERIAL_ACE, MOVE_ROCK_TOMB, MOVE_GIGA_DRAIN, MOVE_MUD_SHOT}
    },
    {
    .iv = 196,
    .lvl = 12,
    ...
    .moves = {MOVE_PSYBEAM, MOVE_ROCK_TOMB, MOVE_SIGNAL_BEAM, MOVE_SELF_DESTRUCT}
    }
};
...
static const struct TrainerMon sParty_Tiana[] = {
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_MEGA_DRAIN, MOVE_PROTECT, MOVE_LEECH_SEED, MOVE_SYNTHESIS}
    },
    {
    .iv = 196,
    .lvl = 5,
    .species = SPECIES_SUNKERN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_SOFT_BOILED, MOVE_METRONOME, MOVE_NONE, MOVE_NONE}
    },
};
...
static const struct TrainerMon sParty_Janice[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TICKLE, MOVE_PRESENT, MOVE_SING, MOVE_NONE}
    },
    {
    .iv = 147,
    .lvl = 10,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_SECRET_POWER, MOVE_TOXIC, MOVE_NONE}
    },
    {
    .iv = 252,
    .lvl = 9,
    .species = SPECIES_MARILL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_SECRET_POWER, MOVE_TICKLE, MOVE_NONE}
    }
};
...
static const struct TrainerMon sParty_Rick[] = {
    ...
    .moves = {MOVE_TACKLE, MOVE_POISON_STING, MOVE_STRING_SHOT, MOVE_NONE}
    },
    {
    .iv = 252,
    .lvl = 5,
    ...
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_POISON_STING, MOVE_IRON_DEFENSE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 252,
    .lvl = 5,
...
static const struct TrainerMon sParty_Jose[] = {
    ...
    .species = SPECIES_DUSTOX,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CONFUSION, MOVE_TOXIC, MOVE_LIGHT_SCREEN, MOVE_IRON_DEFENSE}
    },
    {
    .iv = 196,
    .lvl = 10,
    .species = SPECIES_BEAUTIFLY,
    .heldItem = ITEM_MIRACLE_SEED,
    .moves = {MOVE_GUST, MOVE_LEECH_LIFE, MOVE_MEGA_DRAIN, MOVE_STUN_SPORE}
    },
    {
    .iv = 196,
    .lvl = 10,
    ...
    .heldItem = ITEM_BLACK_BELT,
    .moves = {MOVE_ROCK_SMASH, MOVE_AERIAL_ACE, MOVE_SECRET_POWER, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 196,
    .lvl = 10,
    ...
    .heldItem = ITEM_CHERI_BERRY,
    .moves = {MOVE_MEGA_DRAIN, MOVE_CONFUSION, MOVE_SUPERSONIC, MOVE_STUN_SPORE}
    }
};
...
static const struct TrainerMon sParty_Clark[] = {
    ...
    .species = SPECIES_SLUGMA,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_FLAME_WHEEL, MOVE_ROCK_TOMB, MOVE_BODY_SLAM, MOVE_RECOVER}
    },
    {
    .iv = 196,
    .lvl = 10,
    ...
    .moves = {MOVE_LICK, MOVE_FACADE, MOVE_SNORE, MOVE_REST}
    },
    {
    .iv = 196,
    .lvl = 10,
    .species = SPECIES_GULPIN,
    .heldItem = ITEM_BERRY_JUICE,
    .moves = {MOVE_ACID, MOVE_SECRET_POWER, MOVE_TOXIC, MOVE_SWALLOW}
    }
};
...
static const struct TrainerMon sParty_Dawson[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_MUD_SHOT, MOVE_ROCK_TOMB, MOVE_SECRET_POWER, MOVE_ICE_SHARD}
    },
    {
    .iv = 252,
    .lvl = 10,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_SECRET_POWER, MOVE_THUNDER_WAVE, MOVE_NONE}
    },
    {
    .iv = 196,
    .lvl = 9,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FAKE_OUT, MOVE_AERIAL_ACE, MOVE_CUT, MOVE_TICKLE}
    }
};
...
static const struct TrainerMon sParty_Sarah[] = {
    ...
    .species = SPECIES_SPOINK,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_CONFUSION, MOVE_BOUNCE, MOVE_SECRET_POWER, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 147,
    .lvl = 10,
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_AERIAL_ACE, MOVE_PAY_DAY, MOVE_BITE}
    },
    {
    .iv = 196,
    .lvl = 10,
    ...
    .heldItem = ITEM_POISON_BARB,
    .moves = {MOVE_ACID, MOVE_SECRET_POWER, MOVE_MEGA_DRAIN, MOVE_STUN_SPORE}
    }
};
...
static const struct TrainerMon sParty_Devan[] = {
    ...
    .species = SPECIES_GEODUDE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_TOMB, MOVE_DIG, MOVE_SECRET_POWER, MOVE_SEISMIC_TOSS}
    },
    {
    .iv = 196,
    .lvl = 9,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_AERIAL_ACE, MOVE_DIG, MOVE_SECRET_POWER}
    },
    {
    .iv = 252,
    .lvl = 9,
    .species = SPECIES_TRAPINCH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_DIG, MOVE_ROCK_TOMB, MOVE_SECRET_POWER}
    }
};
...
static const struct TrainerMon sParty_Johnson[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSION, MOVE_REFLECT, MOVE_NIGHT_SHADE, MOVE_HYPNOSIS}
    },
    {
    .iv = 147,
    .lvl = 9,
    .species = SPECIES_SWABLU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_SECRET_POWER, MOVE_REST, MOVE_SING}
    },
    {
    .iv = 147,
    .lvl = 9,
    .species = SPECIES_NATU,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CONFUSION, MOVE_AERIAL_ACE, MOVE_NIGHT_SHADE, MOVE_CONFUSE_RAY}
    }
};
...
static const struct TrainerMon sParty_Red[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_QUICK_ATTACK, MOVE_SNORE, MOVE_CURSE, MOVE_REST}
    },
    {
    .iv = 252,
    .lvl = 9,
