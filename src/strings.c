...
const u8 gText_Starter[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}STARTER");
...
const u8 gText_StarterChoiceNumber[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}");
...
const u8 gText_IVYSAUR[] = _("Ivysaur");
const u8 gText_VENUSAUR[] = _("Venusaur");
const u8 gText_CHARMANDER[] = _("Charmander");
const u8 gText_CHARMELEON[] = _("Charmeleon");
const u8 gText_CHARIZARD[] = _("Charizard");
const u8 gText_SQUIRTLE[] = _("Squirtle");
const u8 gText_WARTORTLE[] = _("Wartortle");
const u8 gText_BLASTOISE[] = _("Blastoise");
const u8 gText_CATERPIE[] = _("Caterpie");
const u8 gText_METAPOD[] = _("Metapod");
const u8 gText_BUTTERFREE[] = _("Butterfree");
const u8 gText_WEEDLE[] = _("Weedle");
const u8 gText_KAKUNA[] = _("Kakuna");
const u8 gText_BEEDRILL[] = _("Beedrill");
const u8 gText_PIDGEY[] = _("Pidgey");
const u8 gText_PIDGEOTTO[] = _("Pidgeotto");
const u8 gText_PIDGEOT[] = _("Pidgeot");
const u8 gText_RATTATA[] = _("Rattata");
const u8 gText_RATICATE[] = _("Raticate");
const u8 gText_SPEAROW[] = _("Spearow");
const u8 gText_FEAROW[] = _("Fearow");
const u8 gText_EKANS[] = _("Ekans");
const u8 gText_ARBOK[] = _("Arbok");
const u8 gText_PIKACHU[] = _("Pikachu");
const u8 gText_RAICHU[] = _("Raichu");
const u8 gText_SANDSHREW[] = _("Sandshrew");
const u8 gText_SANDSLASH[] = _("Sandslash");
const u8 gText_NIDORAN_F[] = _("NidoranF");
const u8 gText_NIDORINA[] = _("Nidorina");
const u8 gText_NIDOQUEEN[] = _("Nidoqueen");
const u8 gText_NIDORAN_M[] = _("NidoranM");
const u8 gText_NIDORINO[] = _("Nidorino");
const u8 gText_NIDOKING[] = _("Nidoking");
const u8 gText_CLEFAIRY[] = _("Clefairy");
const u8 gText_CLEFABLE[] = _("Clefable");
const u8 gText_VULPIX[] = _("Vulpix");
const u8 gText_NINETALES[] = _("Ninetales");
const u8 gText_JIGGLYPUFF[] = _("Jigglypuff");
const u8 gText_WIGGLYTUFF[] = _("Wigglytuff");
const u8 gText_ZUBAT[] = _("Zubat");
const u8 gText_GOLBAT[] = _("Golbat");
const u8 gText_ODDISH[] = _("Oddish");
const u8 gText_GLOOM[] = _("Gloom");
const u8 gText_VILEPLUME[] = _("Vileplume");
const u8 gText_PARAS[] = _("Paras");
const u8 gText_PARASECT[] = _("Parasect");
const u8 gText_VENONAT[] = _("Venonat");
const u8 gText_VENOMOTH[] = _("Venomoth");
const u8 gText_DIGLETT[] = _("Diglett");
const u8 gText_DUGTRIO[] = _("Dugtrio");
const u8 gText_MEOWTH[] = _("Meowth");
const u8 gText_PERSIAN[] = _("Persian");
const u8 gText_PSYDUCK[] = _("Psyduck");
const u8 gText_GOLDUCK[] = _("Golduck");
const u8 gText_MANKEY[] = _("Mankey");
const u8 gText_PRIMEAPE[] = _("Primeape");
const u8 gText_GROWLITHE[] = _("Growlithe");
const u8 gText_ARCANINE[] = _("Arcanine");
const u8 gText_POLIWAG[] = _("Poliwag");
const u8 gText_POLIWHIRL[] = _("Poliwhirl");
const u8 gText_POLIWRATH[] = _("Poliwrath");
const u8 gText_ABRA[] = _("Abra");
const u8 gText_KADABRA[] = _("Kadabra");
const u8 gText_ALAKAZAM[] = _("Alakazam");
const u8 gText_MACHOP[] = _("Machop");
const u8 gText_MACHOKE[] = _("Machoke");
const u8 gText_MACHAMP[] = _("Machamp");
const u8 gText_BELLSPROUT[] = _("Bellsprout");
const u8 gText_WEEPINBELL[] = _("Weepinbell");
const u8 gText_VICTREEBEL[] = _("Victreebel");
const u8 gText_TENTACOOL[] = _("Tentacool");
const u8 gText_TENTACRUEL[] = _("Tentacruel");
const u8 gText_GEODUDE[] = _("Geodude");
const u8 gText_GRAVELER[] = _("Graveler");
const u8 gText_GOLEM[] = _("Golem");
const u8 gText_PONYTA[] = _("Ponyta");
const u8 gText_RAPIDASH[] = _("Rapidash");
const u8 gText_SLOWPOKE[] = _("Slowpoke");
const u8 gText_SLOWBRO[] = _("Slowbro");
const u8 gText_MAGNEMITE[] = _("Magnemite");
const u8 gText_MAGNETON[] = _("Magneton");
const u8 gText_FARFETCHD[] = _("Farfetch'd");
const u8 gText_DODUO[] = _("Doduo");
const u8 gText_DODRIO[] = _("Dodrio");
const u8 gText_SEEL[] = _("Seel");
const u8 gText_DEWGONG[] = _("Dewgong");
const u8 gText_GRIMER[] = _("Grimer");
const u8 gText_MUK[] = _("Muk");
const u8 gText_SHELLDER[] = _("Shellder");
const u8 gText_CLOYSTER[] = _("Cloyster");
const u8 gText_GASTLY[] = _("Gastly");
const u8 gText_HAUNTER[] = _("Haunter");
const u8 gText_GENGAR[] = _("Gengar");
const u8 gText_ONIX[] = _("Onix");
const u8 gText_DROWZEE[] = _("Drowzee");
const u8 gText_HYPNO[] = _("Hypno");
const u8 gText_KRABBY[] = _("Krabby");
const u8 gText_KINGLER[] = _("Kingler");
const u8 gText_VOLTORB[] = _("Voltorb");
const u8 gText_ELECTRODE[] = _("Electrode");
const u8 gText_EXEGGCUTE[] = _("Exeggcute");
const u8 gText_EXEGGUTOR[] = _("Exeggutor");
const u8 gText_CUBONE[] = _("Cubone");
const u8 gText_MAROWAK[] = _("Marowak");
const u8 gText_HITMONLEE[] = _("Hitmonlee");
const u8 gText_HITMONCHAN[] = _("Hitmonchan");
const u8 gText_LICKITUNG[] = _("Lickitung");
const u8 gText_KOFFING[] = _("Koffing");
const u8 gText_WEEZING[] = _("Weezing");
const u8 gText_RHYHORN[] = _("Rhyhorn");
const u8 gText_RHYDON[] = _("Rhydon");
const u8 gText_CHANSEY[] = _("Chansey");
const u8 gText_TANGELA[] = _("Tangela");
const u8 gText_KANGASKHAN[] = _("Kangaskhan");
const u8 gText_HORSEA[] = _("Horsea");
const u8 gText_SEADRA[] = _("Seadra");
const u8 gText_GOLDEEN[] = _("Goldeen");
const u8 gText_SEAKING[] = _("Seaking");
const u8 gText_STARYU[] = _("Staryu");
const u8 gText_STARMIE[] = _("Starmie");
const u8 gText_MR_MIME[] = _("Mr Mime");
const u8 gText_SCYTHER[] = _("Scyther");
const u8 gText_JYNX[] = _("Jynx");
const u8 gText_ELECTABUZZ[] = _("Electabuzz");
const u8 gText_MAGMAR[] = _("Magmar");
const u8 gText_PINSIR[] = _("Pinsir");
const u8 gText_TAUROS[] = _("Tauros");
const u8 gText_MAGIKARP[] = _("Magikarp");
const u8 gText_GYARADOS[] = _("Gyarados");
const u8 gText_LAPRAS[] = _("Lapras");
const u8 gText_DITTO[] = _("Ditto");
...
const u8 gText_OMANYTE[] = _("Omanyte");
const u8 gText_OMASTAR[] = _("Omastar");
const u8 gText_KABUTO[] = _("Kabuto");
const u8 gText_KABUTOPS[] = _("Kabutops");
const u8 gText_AERODACTYL[] = _("Aerodactyl");
const u8 gText_SNORLAX[] = _("Snorlax");
const u8 gText_ARTICUNO[] = _("Articuno");
const u8 gText_ZAPDOS[] = _("Zapdos");
const u8 gText_MOLTRES[] = _("Moltres");
const u8 gText_DRATINI[] = _("Dratini");
const u8 gText_DRAGONAIR[] = _("Dragonair");
const u8 gText_DRAGONITE[] = _("Dragonite");
const u8 gText_MEWTWO[] = _("Mewtwo");
const u8 gText_MEW[] = _("Mew");
const u8 gText_CHIKORITA[] = _("Chikorita");
const u8 gText_BAYLEEF[] = _("Bayleef");
const u8 gText_MEGANIUM[] = _("Meganium");
const u8 gText_CYNDAQUIL[] = _("Cyndaquil");
const u8 gText_QUILAVA[] = _("Quilava");
const u8 gText_TYPHLOSION[] = _("Typhlosion");
const u8 gText_TOTODILE[] = _("Totodile");
const u8 gText_CROCONAW[] = _("Croconaw");
const u8 gText_FERALIGATR[] = _("Feraligatr");
const u8 gText_SENTRET[] = _("Sentret");
const u8 gText_FURRET[] = _("Furret");
const u8 gText_HOOTHOOT[] = _("Hoothoot");
const u8 gText_NOCTOWL[] = _("Noctowl");
const u8 gText_LEDYBA[] = _("Ledya");
const u8 gText_LEDIAN[] = _("Leduan");
const u8 gText_SPINARAK[] = _("Spinarak");
const u8 gText_ARIADOS[] = _("Ariados");
const u8 gText_CROBAT[] = _("Crobat");
const u8 gText_CHINCHOU[] = _("Chinchou");
const u8 gText_LANTURN[] = _("Lanturn");
const u8 gText_PICHU[] = _("Pichu");
const u8 gText_CLEFFA[] = _("Cleffa");
const u8 gText_IGGLYBUFF[] = _("Igglybuff");
const u8 gText_TOGEPI[] = _("Togepi");
const u8 gText_TOGETIC[] = _("Togetic");
const u8 gText_NATU[] = _("Natu");
const u8 gText_XATU[] = _("Xatu");
const u8 gText_MAREEP[] = _("Mareep");
const u8 gText_FLAAFFY[] = _("Flaaffy");
const u8 gText_AMPHAROS[] = _("Ampharos");
const u8 gText_BELLOSSOM[] = _("Bellossom");
const u8 gText_MARILL[] = _("Marill");
const u8 gText_AZUMARILL[] = _("Azumarill");
const u8 gText_SUDOWOODO[] = _("Sudowoodo");
const u8 gText_POLITOED[] = _("Politoed");
const u8 gText_HOPPIP[] = _("Hoppip");
const u8 gText_SKIPLOOM[] = _("Skiploom");
const u8 gText_JUMPLUFF[] = _("Jumplufff");
const u8 gText_AIPOM[] = _("Aipom");
const u8 gText_SUNKERN[] = _("Sunkern");
const u8 gText_SUNFLORA[] = _("Sunflora");
const u8 gText_YANMA[] = _("Yanma");
const u8 gText_WOOPER[] = _("Wooper");
const u8 gText_QUAGSIRE[] = _("Quagsire");
const u8 gText_ESPEON[] = _("Espeon");
const u8 gText_UMBREON[] = _("Umbreom");
const u8 gText_MURKROW[] = _("Murkrow");
const u8 gText_SLOWKING[] = _("Slowking");
const u8 gText_MISDREAVUS[] = _("Misdreavus");
const u8 gText_UNOWN[] = _("Unown");
const u8 gText_WOBBUFFET[] = _("Wobbuffet");
const u8 gText_GIRAFARIG[] = _("GIrafarig");
const u8 gText_PINECO[] = _("Pineco");
const u8 gText_FORRETRESS[] = _("Forretress");
const u8 gText_DUNSPARCE[] = _("Dunsparce");
const u8 gText_GLIGAR[] = _("Gligar");
const u8 gText_STEELIX[] = _("Steelix");
const u8 gText_SNUBBULL[] = _("Snubbull");
const u8 gText_GRANBULL[] = _("Granbull");
const u8 gText_QWILFISH[] = _("Qwilfish");
const u8 gText_SCIZOR[] = _("Scizor");
const u8 gText_SHUCKLE[] = _("Shuckle");
const u8 gText_HERACROSS[] = _("Heracross");
const u8 gText_SNEASEL[] = _("Sneasel");
const u8 gText_TEDDIURSA[] = _("Teddiursa");
const u8 gText_URSARING[] = _("Ursaring");
const u8 gText_SLUGMA[] = _("Slugma");
const u8 gText_MAGCARGO[] = _("Magcargo");
const u8 gText_SWINUB[] = _("Swinub");
const u8 gText_PILOSWINE[] = _("Piloswine");
const u8 gText_CORSOLA[] = _("Corsola");
const u8 gText_REMORAID[] = _("Remorai");
const u8 gText_OCTILLERY[] = _("Octillery");
const u8 gText_DELIBIRD[] = _("Delibird");
const u8 gText_MANTINE[] = _("Mantine");
const u8 gText_SKARMORY[] = _("Skarmory");
const u8 gText_HOUNDOUR[] = _("Houndour");
const u8 gText_HOUNDOOM[] = _("Houndoom");
const u8 gText_KINGDRA[] = _("Kingdra");
const u8 gText_PHANPY[] = _("Phanpy");
const u8 gText_DONPHAN[] = _("Donphan");
const u8 gText_PORYGON2[] = _("Porygon2");
const u8 gText_STANTLER[] = _("Stantler");
const u8 gText_SMEARGLE[] = _("Smeargle");
const u8 gText_TYROGUE[] = _("Tyrogue");
const u8 gText_HITMONTOP[] = _("Hitmontop");
const u8 gText_SMOOCHUM[] = _("Smoochum");
const u8 gText_ELEKID[] = _("Elekid");
const u8 gText_MAGBY[] = _("Magby");
const u8 gText_MILTANK[] = _("Miltank");
const u8 gText_BLISSEY[] = _("Blissey");
...
const u8 gText_PUPITAR[] = _("Pupitar");
const u8 gText_TYRANITAR[] = _("Tyranitar");
const u8 gText_LUGIA[] = _("Lugia");
const u8 gText_HO_OH[] = _("Ho oh");
const u8 gText_CELEBI[] = _("Celebi");
const u8 gText_TREECKO[] = _("Treecko");
const u8 gText_GROVYLE[] = _("Grovyle");
const u8 gText_SCEPTILE[] = _("Sceptile");
const u8 gText_TORCHIC[] = _("Torchic");
const u8 gText_COMBUSKEN[] = _("Combusken");
const u8 gText_BLAZIKEN[] = _("Blaziken");
const u8 gText_MUDKIP[] = _("Mudkip");
const u8 gText_MARSHTOMP[] = _("Marshtomp");
const u8 gText_SWAMPERT[] = _("Swampert");
const u8 gText_POOCHYENA[] = _("Poocheyna");
const u8 gText_MIGHTYENA[] = _("Mightyena");
const u8 gText_ZIGZAGOON[] = _("Zigzagoon");
const u8 gText_LINOONE[] = _("Linoone");
const u8 gText_WURMPLE[] = _("Wurmple");
const u8 gText_SILCOON[] = _("Silcoon");
const u8 gText_BEAUTIFLY[] = _("Beautifly");
const u8 gText_CASCOON[] = _("Cascoon");
const u8 gText_DUSTOX[] = _("Dustox");
const u8 gText_LOTAD[] = _("Lotad");
const u8 gText_LOMBRE[] = _("Lombre");
const u8 gText_LUDICOLO[] = _("Ludicolo");
const u8 gText_SEEDOT[] = _("Seedot");
const u8 gText_NUZLEAF[] = _("Nuzleaf");
const u8 gText_SHIFTRY[] = _("Shiftry");
const u8 gText_NINCADA[] = _("Nincada");
const u8 gText_NINJASK[] = _("Ninjask");
const u8 gText_SHEDINJA[] = _("Shedina");
const u8 gText_TAILLOW[] = _("Taillow");
const u8 gText_SWELLOW[] = _("Swellow");
const u8 gText_SHROOMISH[] = _("Shroomish");
const u8 gText_BRELOOM[] = _("Breloom");
const u8 gText_SPINDA[] = _("Spinda");
const u8 gText_WINGULL[] = _("Wingull");
const u8 gText_PELIPPER[] = _("Pelipper");
const u8 gText_SURSKIT[] = _("Surskit");
const u8 gText_MASQUERAIN[] = _("Masquerain");
const u8 gText_WAILMER[] = _("Wailmer");
const u8 gText_WAILORD[] = _("Wailord");
const u8 gText_SKITTY[] = _("Skitty");
const u8 gText_DELCATTY[] = _("Delcatty");
const u8 gText_KECLEON[] = _("Kecleon");
const u8 gText_BALTOY[] = _("Baltoy");
const u8 gText_CLAYDOL[] = _("Claydol");
const u8 gText_NOSEPASS[] = _("Nosepass");
const u8 gText_TORKOAL[] = _("Torkoal");
const u8 gText_SABLEYE[] = _("Sableye");
const u8 gText_BARBOACH[] = _("Barboach");
const u8 gText_WHISCASH[] = _("Whiscash");
const u8 gText_LUVDISC[] = _("Luvdisc");
const u8 gText_CORPHISH[] = _("Corpish");
const u8 gText_CRAWDAUNT[] = _("Crawdaunt");
const u8 gText_FEEBAS[] = _("Feebas");
const u8 gText_MILOTIC[] = _("Milotic");
const u8 gText_CARVANHA[] = _("Carvanha");
const u8 gText_SHARPEDO[] = _("Sharpedo");
const u8 gText_TRAPINCH[] = _("Trapinch");
const u8 gText_VIBRAVA[] = _("Vibrava");
const u8 gText_FLYGON[] = _("Flygon");
const u8 gText_MAKUHITA[] = _("Makuhita");
const u8 gText_HARIYAMA[] = _("Hariyama");
const u8 gText_ELECTRIKE[] = _("Electrike");
const u8 gText_MANECTRIC[] = _("Manectric");
const u8 gText_NUMEL[] = _("Numel");
const u8 gText_CAMERUPT[] = _("Camerup");
const u8 gText_SPHEAL[] = _("Spheal");
const u8 gText_SEALEO[] = _("Sealeo");
const u8 gText_WALREIN[] = _("Walrein");
const u8 gText_CACNEA[] = _("Cacnea");
const u8 gText_CACTURNE[] = _("Cacturne");
const u8 gText_SNORUNT[] = _("Snorut");
const u8 gText_GLALIE[] = _("Glalie");
const u8 gText_LUNATONE[] = _("Lunatone");
const u8 gText_SOLROCK[] = _("Solrock");
const u8 gText_AZURILL[] = _("Azurill");
const u8 gText_SPOINK[] = _("Spoink");
const u8 gText_GRUMPIG[] = _("Grumpig");
const u8 gText_PLUSLE[] = _("Plusle");
const u8 gText_MINUN[] = _("Minun");
const u8 gText_MAWILE[] = _("Mawile");
const u8 gText_MEDITITE[] = _("Meditite");
const u8 gText_MEDICHAM[] = _("Medicham");
const u8 gText_SWABLU[] = _("Swablu");
const u8 gText_ALTARIA[] = _("Altaria");
const u8 gText_WYNAUT[] = _("Wynaut");
const u8 gText_DUSKULL[] = _("Duskull");
const u8 gText_DUSCLOPS[] = _("Dusclops");
const u8 gText_ROSELIA[] = _("Roselia");
const u8 gText_SLAKOTH[] = _("Slakoth");
const u8 gText_VIGOROTH[] = _("Vigoroth");
const u8 gText_SLAKING[] = _("Slaking");
const u8 gText_GULPIN[] = _("Gulpin");
const u8 gText_SWALOT[] = _("Swalot");
const u8 gText_TROPIUS[] = _("Tropius");
const u8 gText_WHISMUR[] = _("Whismur");
const u8 gText_LOUDRED[] = _("Loudred");
const u8 gText_EXPLOUD[] = _("Exploud");
const u8 gText_CLAMPERL[] = _("Clamperl");
const u8 gText_HUNTAIL[] = _("Huntail");
const u8 gText_GOREBYSS[] = _("Gorebyss");
const u8 gText_ABSOL[] = _("Absol");
const u8 gText_SHUPPET[] = _("Shuppet");
const u8 gText_BANETTE[] = _("Banette");
const u8 gText_SEVIPER[] = _("Seviper");
const u8 gText_ZANGOOSE[] = _("Zangoose");
const u8 gText_RELICANTH[] = _("Relicanth");
const u8 gText_ARON[] = _("Aron");
const u8 gText_LAIRON[] = _("Lairon");
const u8 gText_AGGRON[] = _("Aggron");
const u8 gText_CASTFORM[] = _("Castform");
const u8 gText_VOLBEAT[] = _("Volbeat");
const u8 gText_ILLUMISE[] = _("Illumise");
const u8 gText_LILEEP[] = _("Lileep");
const u8 gText_CRADILY[] = _("Cradily");
const u8 gText_ANORITH[] = _("Anorith");
const u8 gText_ARMALDO[] = _("Almaldo");
const u8 gText_RALTS[] = _("Ralts");
const u8 gText_KIRLIA[] = _("Kirlia");
const u8 gText_GARDEVOIR[] = _("Gardevoir");
const u8 gText_BAGON[] = _("Bagon");
const u8 gText_SHELGON[] = _("Shelgon");
const u8 gText_SALAMENCE[] = _("Salamence");
const u8 gText_BELDUM[] = _("Beldum");
const u8 gText_METANG[] = _("Metang");
const u8 gText_METAGROSS[] = _("Metagross");
const u8 gText_REGIROCK[] = _("Regirock");
const u8 gText_REGICE[] = _("Regice");
const u8 gText_REGISTEEL[] = _("Registeel");
const u8 gText_KYOGRE[] = _("Kyogre");
const u8 gText_GROUDON[] = _("Groudon");
const u8 gText_RAYQUAZA[] = _("Rayquaza");
const u8 gText_LATIAS[] = _("Latias");
const u8 gText_LATIOS[] = _("Latios");
const u8 gText_JIRACHI[] = _("Jirachi");
const u8 gText_DEOXYS[] = _("Deoxys");
const u8 gText_CHIMECHO[] = _("Chimecho");
