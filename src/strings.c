...
const u8 gText_NIDORANF[] = _("{COLOR RED}{SHADOW LIGHT_RED}NidoranF");
...
const u8 gText_NIDORANM[] = _("{COLOR RED}{SHADOW LIGHT_RED}NidoranM");
...
const u8 gText_HOOH[] = _("{COLOR RED}{SHADOW LIGHT_RED}Ho oh");
